...
/// The state of a [FsStep] which is used to control the style of the circle and
/// text.
///
/// See also:
///
...
/// A material step used in [FsStepper]. The step can have a title and subtitle,
...
@immutable
class FsStep {
  /// Creates a step for a [FsStepper].
  ///
...
class FsStepper extends StatefulWidget {
  ...
  @override
  _FsStepperState createState() => _FsStepperState();
}

class _FsStepperState extends State<FsStepper> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(FsStepper oldWidget) {
  ...
  Widget _buildVerticalBody(int index) {
    return Stack(
      children: <Widget>[
        ...
        widget.steps[index].content == null
            ? Container()
            : AnimatedCrossFade(
      ...
      children: <Widget>[
        ...
        Expanded(
          child: ListView(
            ...
            children: <Widget>[
              widget.steps[widget.currentStep].content == null
                  ? Container()
                  : AnimatedSize(
                      curve: Curves.fastOutSlowIn,
                      duration: kThemeAnimationDuration,
  ...
  Widget build(BuildContext context) {
    ...
    assert(() {
      if (context.findAncestorWidgetOfExactType<FsStepper>() != null)
