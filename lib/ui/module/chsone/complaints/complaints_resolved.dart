...
class ComplaintsResolved extends StatefulWidget {
  @override
  _ComplaintsResolvedState createState() => new _ComplaintsResolvedState();
}

class _ComplaintsResolvedState extends State<ComplaintsResolved> {
  @override
