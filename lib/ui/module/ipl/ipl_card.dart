...
class IplCard extends StatefulWidget {
  String profileurl;

  IplCard({this.profileurl});
...
class _IplCardState extends State<IplCard> {
  Timer timer;
  ...
  int team1score = 0, team2score = 0, team1wickets = 0, team2wickets = 0;
  String team1overs = "0";
  String team2overs = "0";
  ...
  Future getUser() async {
    await SsoStorage.getUserProfile().then((value) async {
            ...
            if (mounted) {
              setState(() {
                ...
                if (value['data']['live_score'] != null) {
                  ...
                  if (livescores != null &&
                      livescores.length > 0 &&
                      value['data']['live_score'][0]['localteam']['score']
                              ['score'] !=
                          null) {
                    _notBatYet = false;
                  ...
                  if (livescores != null &&
                      livescores.length > 0 &&
                      value['data']['live_score'][0]['visitorteam']['score']
                              ['score'] !=
                          null) {
                    _notbatyet1 = false;
                  ...
                  if (livescores.length == 2) {
                    ...
                    if (value['data']['live_score'][1]['visitorteam']['score']
                      ...
                      team2score = value['data']['live_score'][1]['visitorteam']
                          ['score']['score'];
                      team2wickets = value['data']['live_score'][1]
                          ['visitorteam']['score']['wickets'];
          ...
          child: Container(
            child: Column(
              ...
              children: <Widget>[
                ...
                teams != null && teams.length > 0 && teams[0]['winner'] != null
                    ? Padding(
